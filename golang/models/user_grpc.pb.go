...
type UserServiceClient interface {
	...
	GetUserByCode(ctx context.Context, in *GetUserByCodeRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) GetUserByCode(ctx context.Context, in *GetUserByCodeRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/UserService/GetUserByCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetUserByCode(context.Context, *GetUserByCodeRequest) (*User, error)
...
func (UnimplementedUserServiceServer) GetUserByCode(context.Context, *GetUserByCodeRequest) (*User, error) {
...
func _UserService_GetUserByCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UserService/GetUserByCode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserByCode(ctx, req.(*GetUserByCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
